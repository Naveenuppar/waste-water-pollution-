"""detection_of_wastewater_pollution URL Configuration
...
from detection_of_wastewater_pollution import settings
...
urlpatterns = [
    ...
    url(r'^Predict_WasteWater_Pollution_Type/$', remoteuser.Predict_WasteWater_Pollution_Type, name="Predict_WasteWater_Pollution_Type"),
    ...
    url(r'^View_Prediction_Of_WasteWater_Pollution_Type_Ratio/$', serviceprovider.View_Prediction_Of_WasteWater_Pollution_Type_Ratio, name="View_Prediction_Of_WasteWater_Pollution_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_WasteWater_Pollution_Type/$', serviceprovider.View_Prediction_Of_WasteWater_Pollution_Type, name="View_Prediction_Of_WasteWater_Pollution_Type"),
